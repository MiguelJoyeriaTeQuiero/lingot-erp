-- =====================================================================
-- Lingot ERP — Migración 020: fix digest() — pgcrypto en extensions
-- Supabase instala pgcrypto en el schema "extensions", no en "public".
-- emit_document tenía SET search_path = public y no encontraba digest().
-- =====================================================================
