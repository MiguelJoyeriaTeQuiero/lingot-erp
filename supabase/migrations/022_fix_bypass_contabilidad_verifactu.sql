-- =====================================================================
-- Migración 022: restaurar bypass del guard de contabilidad en emit_document
-- Las migraciones 019/020 (verifactu) reescribieron emit_document sin el
-- set_config('app.bypass_contabilidad_guard', 'true', ...) que introdujo
-- la migración 015, provocando que el trigger bloqueara series_id/number/code
-- al emitir con rol contabilidad.
-- =====================================================================
